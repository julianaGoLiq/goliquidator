<?php
add_filter('the_posts', 'pssw_variation_query');

function pssw_variation_query($posts, $query = false) {
    ...
    if (is_search() && !is_admin()) 
    {
        ...
        $matchedSku = pssw_get_parent_post_by_sku(get_search_query(), $ignoreIds);
...
function pssw_get_parent_post_by_sku($sku, $ignoreIds) {
    //Check for 
