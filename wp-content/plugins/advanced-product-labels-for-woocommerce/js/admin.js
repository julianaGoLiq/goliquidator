...
(function ($){
    ...
    $(document).ready( function () {
        ...
        function br_apl_reload_labels_preview_ajax(form) {
            ...
            br_label_ajax_demo = $.post(ajaxurl, form_data+'&action=br_label_ajax_demo', function(data) {
                $('.berocket_label_preview_wrap .br_alabel, .br_label_update_on_demo').remove();
                ...
                $('.br_alabel').trigger('br-update-label');
            });
        }
    ...
    function br_hideOptions( e ) {
        var checkbox = $(e.target),
            options_class = checkbox.attr('id').replace('_use', '_option'),
