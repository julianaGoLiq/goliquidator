...
class Slider implements Lib\ShortcodeInterface {
    ...
    public function render($atts, $content = null) {
        ...
        if ($slider != "") {
            ...
            if($suprema_qodef_options['smooth_page_transitions'] == "yes" && $suprema_qodef_options['smooth_pt_spinner_type'] != "") {
                $ajax_loader = '<div class="qodef-st-loader"><div class="qodef-st-loader1">' . suprema_qodef_loading_spinners(true) . '</div></div>';
            }else{
                $ajax_loader = '<div class="qodef-st-loader"><div class="qodef-st-loader1">'. suprema_qodef_loading_spinner_pulse() .'</div></div>';
            }

            /* set slider preloader - end */

            /* set padding for slider arrows - start */
           $navigation_vertical_align = $slider_meta['navigation_vertical_align'];
			
            if($navigation_vertical_align == 'window_top') {
                $slider_arrows_padding = "padding-top: 0px;";
            }elseif($navigation_vertical_align == 'bottom_of_header') {
				$slider_arrows_padding = "padding-top: " . esc_attr($this->suprema_qodef_get_slider_item_padding()) . "px;";
			}  else {
				$slider_arrows_padding = "padding-top: " . esc_attr($this->suprema_qodef_get_slider_navigation_padding()) . "px;";
			}
            /* set padding for slider arrows - end */

            $html .= '<div id="qodef-' . esc_attr($slider) . '" ' . $slider_anchor . ' ' . $responsiveness_data . ' ' . $responsive_coefficients_graphic_data . ' ' . $responsive_coefficients_title_data . ' ' . $responsive_coefficients_subtitle_data . ' ' . $responsive_coefficients_text_data . ' ' . $responsive_coefficients_button_data . ' class="carousel slide ' . esc_attr($animation_type_class . ' ' . $full_screen_class . ' ' . $responsive_height_class . ' ' . $height_class . ' ' . $auto_start_class . ' ' . $header_effect_class . ' ' . $slider_numbers_class .  ' ' . $slider_thumbs_class) . ' " ' . $slide_animation_timeout . ' ' . $data_height . ' ' . $data_parallax_effect . ' '.suprema_qodef_get_inline_style($slide_holder_height).'><div class="qodef-slider-preloader">'.$ajax_loader.'</div>';
            $html .= '<div class="carousel-inner ' . esc_attr($slider_css_position_class) . '" '.suprema_qodef_get_inline_style($carouselinner_height).' '.$data_parallax_transform.'>';
            ...
            if (have_posts()) : $postCount = 0;
                while (have_posts()) : the_post();
                    ...
                    $thumbnail_attributes = suprema_qodef_get_attachment_meta_from_url($thumbnail, array('width','height'));
                    ...
                    if (get_post_meta(get_the_ID(), "qodef_slide_content_vertical_middle_type", true) == 'window_top') {
                        ...
                        $slide_item_padding_value = $this->suprema_qodef_get_slider_item_padding();
                    }
                    ...
                    if ($slide_type == 'video') {
                        ...
                        $html .= '<div class="qodef-video"><div class="qodef-mobile-video-image" '.suprema_qodef_get_inline_style('background-image: url(' . esc_url($video_image) . ')').'></div><div class="qodef-video-overlay';
                        ...
                        $html .= '<div class="qodef-image" '.suprema_qodef_get_inline_style('background-image:url(' . esc_url($image) . ')').'>';
                        if ($slider_thumbs == 'no') {
                            $html .= '<img src="' . esc_url($image) . '" alt="' . esc_attr($title) . '">';
                        }

                        if ($image_overlay_pattern !== "") {
                            $html .= '<div class="qodef-image-pattern" '.suprema_qodef_get_inline_style('background: url(' . esc_url($image_overlay_pattern) . ') repeat 0 0').'></div>';
                        }
                        $html .= '</div>';
                    }
                    ...
                    if (($meta_temp_subtitle = get_post_meta(get_the_ID(), "qodef_slide_subtitle", true)) != "") {
                        ...
                        if (($meta_temp = get_post_meta(get_the_ID(), 'qodef_slide_subtitle_background_color', true)) !== '') {
                            ...
                            $slide_subtitle_span_style_array[] = 'background-color: ' . esc_attr(suprema_qodef_rgba_color($slide_subtitle_bg_color, $slide_subtitle_bg_transparency)) . '';
                        }
                        ...
                        //suprema_qodef_inline_style($slide_subtitle_style_array); var_dump($slide_subtitle_style_array); die();
                        $html_text .= '<h3 class="qodef-slide-subtitle" '.suprema_qodef_get_inline_style($slide_subtitle_style_array).'><span '.suprema_qodef_get_inline_style($slide_subtitle_span_style_array).'>' . wp_kses_post($meta_temp_subtitle) . '</span></h3>';
                        $html_text .= '</div>';
                    }
                    ...
                    if (($meta_temp = get_post_meta(get_the_ID(), 'qodef_slide_title_background_color', true)) !== '') {
                        ...
                        $slide_title_span_style_array[] = 'background-color: ' . esc_attr(suprema_qodef_rgba_color($slide_title_bg_color, $slide_title_bg_transparency)) . '';
                    }
                    ...
                    if (get_post_meta(get_the_ID(), "qodef_slide_hide_title", true) == 'no') {
                        $html_text .= '<div class="qodef-el">';
                        $html_text .= '<h2 class="qodef-slide-title" '.suprema_qodef_get_inline_style($slide_title_style_array).'>';
                        ...
                        $html_text .= '<span '.suprema_qodef_get_inline_style($slide_title_span_style_array).'>'.wp_kses_post($title).'</span>';
                        if($meta_temp != '') {
                            $html_text .= '</a>';
                        }
                    ...
                    if (($meta_temp = get_post_meta(get_the_ID(), 'qodef_slide_text_background_color', true) )!== '') {
                        ...
                        $slide_text_span_style_array[] = 'background-color: ' . esc_attr(suprema_qodef_rgba_color($slide_text_bg_color, $slide_text_bg_transparency)) . '';
                    }
                    ...
                    if (($meta_temp = get_post_meta(get_the_ID(), "qodef_slide_text", true)) != "") {
                        $html_text .= '<div class="qodef-el">';
                        $html_text .= '<h3 class="qodef-slide-text" '.suprema_qodef_get_inline_style($slide_text_style_array).'><span '.suprema_qodef_get_inline_style($slide_text_span_style_array).'>'.wp_kses_post($meta_temp).'</span></h3>';
                        $html_text .= '</div>';
                    }
                    ...
                    if ($is_first_button_shown) {
                        ...
                        if ($meta_temp_b1_icon_pack != '') {
                            ...
                            $iconPackName = suprema_qodef_icon_collections()->getIconCollectionParamNameByKey($button1_params['icon_pack']);
                        ...
                        $html_text .= suprema_qodef_get_button_html($button1_params);
                    }
                    ...
                    if ($is_second_button_shown) {
                        ...
                        if ($meta_temp_b2_icon_pack != '') {
                            ...
                            $iconPackName = suprema_qodef_icon_collections()->getIconCollectionParamNameByKey($button2_params['icon_pack']);
                            if (($meta_temp = get_post_meta(get_the_ID(), 'button2_icon_'.$iconPackName, true)) != '') {
                                $button2_params[$iconPackName] = $meta_temp;
                            }
                        }
                        //var_dump($button1_params); die();
                        $html_text .= suprema_qodef_get_button_html($button2_params);
                    }
                    ...
                    if ($separate_text_graphic != 'yes') {
                        $html .= '<div class="qodef-slider-content ' . esc_attr($content_alignment) .'" '.suprema_qodef_get_inline_style($content_width . $content_xaxis . $content_yaxis_start).' '.$slide_data_start.' '.$slide_data_end.'>';
							if(($meta_temp = get_post_meta(get_the_ID(), "qodef_slide_content_vertical_middle", true)) == "yes"){
								$html .= '<div class="qodef-slider-content-inner ' . esc_attr($content_animation . ' ' . $content_animation_direction) .'" '.suprema_qodef_get_inline_style($vertical_content_width . $vertical_content_xaxis).'>';
							}
							$html .= $html_thumb;
							$html .= $html_text;
							if($meta_temp == "yes"){
                        ...
                        $html .= '<div class="qodef-slider-content qodef-graphic-content ' . esc_attr($graphic_alignment) . '" '.suprema_qodef_get_inline_style($graphic_width . $graphic_xaxis . $graphic_yaxis_start).' '. $graphic_data_start .' '.$graphic_data_end.'>';
							if(($meta_temp = get_post_meta(get_the_ID(), "qodef_slide_content_vertical_middle", true)) == "yes"){
								$html .= '<div class="qodef-slider-content-inner" '.suprema_qodef_get_inline_style($vertical_content_width . $vertical_content_xaxis).'>';
							}
							$html .= $html_thumb;
							if($meta_temp == "yes"){
								$html .= '</div>';
            ...
            if ($found_slides > 1) {
                ...
                if ($show_navigation_arrows == "yes") {
                    ...
                    $html .= '<a class="left carousel-control" style="'.$slider_arrows_padding.'" href="#qodef-' . esc_attr($slider) . '" data-slide="prev" data-start="opacity: 1;" data-300="opacity:0;">';
                        if ($slider_thumbs == 'yes') {
                            $html .= '<span class="qodef-thumb-holder"><span class="qodef-thumb-arrow"></span><span class="qodef-numbers"><span class="prev"></span><span class="max-number"> / ' . esc_html($postCount) . '</span></span><span class="img"></span></span>';
                        }
                    ...
                    $html .= '<a class="right carousel-control" style="'.$slider_arrows_padding.'" href="#qodef-' . esc_attr($slider) . '" data-slide="next" data-start="opacity: 1;" data-300="opacity:0;">';
                        if ($slider_thumbs == 'yes') {
                            $html .= '<span class="qodef-thumb-holder"><span class="qodef-numbers"> <span class="next"></span><span class="max-number"> / ' . esc_html($postCount) . '</span></span><span class="qodef-thumb-arrow"></span><span class="img"></span></span>';
                        }
     ...
     **/
    function suprema_qodef_get_slider_item_padding() {
        return apply_filters('suprema_qodef_slider_item_padding', 0);
    }

    /**
     * Function that returns slider navigation pading
     **/
    function suprema_qodef_get_slider_navigation_padding() {
        return apply_filters('suprema_qodef_slider_navigation_padding', 0);
    }
}