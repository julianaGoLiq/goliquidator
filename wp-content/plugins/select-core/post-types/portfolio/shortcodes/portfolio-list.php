    ...
    public function vcMap() {
        if(function_exists('vc_map')) {
            ...
            if(qode_core_theme_installed()) {
                $icons_array = \SupremaQodefIconCollections::get_instance()->getVCParamsArray();
            }
    ...
    public function render($atts, $content = null) {
		...
		if($query_results->have_posts()):			
			while ( $query_results->have_posts() ) : $query_results->the_post(); 
				...
				$html .= qode_core_get_shortcode_module_template_part('portfolio', 'gallery', '', $params);
    ...
    */
	public function getPortfolioIconsHtml($params){
		...
		if (function_exists('suprema_qodef_like_portfolio_list')) {
			$html .= suprema_qodef_like_portfolio_list($id);
		}
	...
	public function getPortfolioClasses($params){
		...
		if($params['hover_type'] != '') {
			switch ($params['hover_type']):
				case 'modern':
					$classes[] = 'qodef-ptf-modern-hover';
				break;
				case 'diagonal':	
					$classes[] = 'qodef-ptf-diagonal-hover';
				break;
				case 'fade':
					$classes[] = 'qodef-ptf-fade-hover';
				break;
			endswitch;
		}
	...
	public function getImageSize($params){
		...
		$thumb_size = 'full';
			...
			if(!empty($params['image_size'])){
				...
				switch ($image_size) {
					case 'landscape':
						$thumb_size = 'suprema_qodef_landscape';
						break;
					case 'portrait':
						$thumb_size = 'suprema_qodef_portrait';
						break;
					case 'square':
