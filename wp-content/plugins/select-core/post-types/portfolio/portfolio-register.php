...
class PortfolioRegister implements PostTypeInterface {
    ...
    private function registerPostType() {
        global $suprema_qodef_Framework, $suprema_qodef_options;
        ...
        if(qode_core_theme_installed()) {
            $menuPosition = $suprema_qodef_Framework->getSkin()->getMenuItemPosition('portfolio');
            $menuIcon = $suprema_qodef_Framework->getSkin()->getMenuIcon('portfolio');

            if(isset($suprema_qodef_options['portfolio_single_slug'])) {
                if($suprema_qodef_options['portfolio_single_slug'] != ""){
                    $slug = $suprema_qodef_options['portfolio_single_slug'];
                }
            }
        }
