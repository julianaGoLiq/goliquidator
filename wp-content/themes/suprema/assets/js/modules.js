        ...
        function updateSliderImages(productImage, thumbImage) {
            if(variableProductsHolder.length) {
                if(typeof thumbImage !== 'undefined') {
                    ...
                    var lastSlash = originalSrc.lastIndexOf('-');
                    var lastDot = originalSrc.lastIndexOf('.');
                    var name = originalSrc.substring(0, lastSlash);
                    var extension = originalSrc.substring(lastDot);
                    var substringSrc = name + extension;
                    ...
                    if(variableProductsImages.length) {
                        variableProductsImages.each(function() {
                            if($(this).attr('data-original-image') == substringSrc) {
            ...
            if (loader.length) {
                ...
                $('a').click(function(e) {
                    ...
                    if (
                        ...
                        !a.hasClass('yith_magnifier_thumbnail') && //Not yith zoom magnifier plugin link
