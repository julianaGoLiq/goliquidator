    ...
    function suprema_qodef_styles() {
        ...
        if(suprema_qodef_is_responsive_on()) {
            ...
            if(file_exists(QODE_ROOT_DIR.'/assets/css/style_dynamic_responsive.css') && suprema_qodef_is_css_folder_writable() && !is_multisite()) {
                wp_enqueue_style('suprema_qodef_style_dynamic_responsive', QODE_ASSETS_ROOT.'/css/style_dynamic_responsive.css', $style_dynamic_deps_array, filemtime(QODE_ROOT_DIR.'/assets/css/style_dynamic_responsive.css'));
            } else {
...
if(!function_exists('suprema_qodef_scripts')) {
    ...
    function suprema_qodef_scripts() {
		...
		foreach (glob(QODE_ROOT_DIR.'/assets/js/modules/plugins/*.js') as $file) {
			$filename = substr($file, strrpos($file, '/') + 1);
			wp_enqueue_script( $filename, QODE_ROOT.'/assets/js/modules/plugins/'.$filename , array('jquery'), false, true );
		}
        ...
        if(suprema_qodef_options()->getOptionValue('google_maps_api_key') != '') {
            $google_maps_api_key = suprema_qodef_options()->getOptionValue('google_maps_api_key');
...
if( !function_exists('suprema_qodef_page_custom_style') ) {
    ...
    function suprema_qodef_page_custom_style() {
       $html = '';
       $style = apply_filters('suprema_qodef_add_page_custom_style', $style = array());
        if($style !== '') {
...
if(!function_exists('suprema_qodef_print_custom_js')) {
    ...
    function suprema_qodef_print_custom_js() {
		...
		echo suprema_qodef_get_module_part($output);
    }
...
if(!function_exists('suprema_qodef_is_zoom_magnifier_installed')) {
    /**
     * Function that checks if YITH Wishlist plugin is installed
     * @return bool
     *
     * @version 0.1
     */
    function suprema_qodef_is_zoom_magnifier_installed() {
        return defined('YITH_WCMG');
    }
}
...
if ( ! function_exists( 'suprema_qodef_get_module_part' ) ) {
	function suprema_qodef_get_module_part( $module ) {
		return $module;
	}
}
...
if ( ! function_exists( 'suprema_qodef_is_gutenberg_installed' ) ) {
	/**
	 * Function that checks if Gutenberg plugin installed
	 * @return bool
	 */
	function suprema_qodef_is_gutenberg_installed() {
		return function_exists( 'is_gutenberg_page' ) && is_gutenberg_page();
	}
}

if ( ! function_exists( 'suprema_qodef_is_wp_gutenberg_installed' ) ) {
	/**
	 * Function that checks if WordPress 5.x with Gutenberg editor installed
	 * @return bool
	 */
	function suprema_qodef_is_wp_gutenberg_installed() {
