...
if(!function_exists('suprema_qodef_woocommerce_create_meta_box')) {
	/**
	 * Function that adds meta box field to product needed for masonry layout
	 */
	function suprema_qodef_woocommerce_create_meta_box() {
		$meta_box = suprema_qodef_create_meta_box(array(
			'scope' => 'product',
			'title' => 'Product Masonry Settings',
			'name'  => 'product-settings-meta-box'
		));

		suprema_qodef_create_meta_box_field(array(
	...
	add_action('suprema_qodef_meta_boxes_map', 'suprema_qodef_woocommerce_create_meta_box');
}
