...
$slider_meta_box = suprema_qodef_create_meta_box(
    array(
        'scope' => array('slides'),
...
$video_meta_box = suprema_qodef_create_meta_box(
    array(
        'scope' => array('slides'),
...
$behaviours_meta_box = suprema_qodef_create_meta_box(
    array(
        'scope' => array('slides'),
...
$title_style_meta_box = suprema_qodef_create_meta_box(
    array(
        'scope' => array('slides'),
    ...
    $slide_title_border = suprema_qodef_create_meta_box_field(array(
        'label' => 'Border',
...
$subtitle_style_meta_box = suprema_qodef_create_meta_box(
    array(
        'scope' => array('slides'),
...
$text_style_meta_box = suprema_qodef_create_meta_box(
    array(
        'scope' => array('slides'),
...
$buttons_style_meta_box = suprema_qodef_create_meta_box(
    array(
        'scope' => array('slides'),
...
$content_positioning_meta_box = suprema_qodef_create_meta_box(
    array(
        'scope' => array('slides'),
